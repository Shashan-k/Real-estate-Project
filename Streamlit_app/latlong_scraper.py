...
def get_coordinates(sector):
    ...
    if response.status_code == 200:
        ...
        coordinates_div = soup.find("div", class_="Z0LcW t2b5Cf") # This is the div that contains the coordinates
        if coordinates_div:
...
# Iterate over sectors and fetch coordinates (total 115 sectors)
