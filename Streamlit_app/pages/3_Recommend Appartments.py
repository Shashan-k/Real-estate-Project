...
st.write("# Recommendation Module")
st.write("### Receive personalized recommendations based on insights.")


st.write('Select a land mark and a radius to find nearby properties')
selected_location = st.selectbox('Location',sorted(location_df.columns.to_list())) # landmark reference

radius = st.number_input('Radius in Kms')   # Distance from landmark
